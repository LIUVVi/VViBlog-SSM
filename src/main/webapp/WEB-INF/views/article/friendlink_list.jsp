...
<div class="header">
    ...
    <ul class="nav">
        ...
        <li><a class="active" href="${pageContext.request.contextPath}/FriendLinks"><i class="fa fa-link fa-fw"></i>友链</a></li>
...
<div class="main">
    <c:forEach items="${links}" var="l">
        <div class="links-box">
            <a href="${l.link}" target="_blank"><i class="fa fa-link"></i> ${l.friend_name}</a>
        </div>
    </c:forEach>
</div>
